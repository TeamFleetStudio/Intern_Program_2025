...
const Footer = () => {
    ...
    return (
        <footer className='w-full h-auto bg-black py-6 px-12 mt-12'>
            ...
            <div className=''>
                <div className='flex flex-col text-left lg:flex-row lg:items-center lg:justify-center gap-x-6 md:gap-x-3 border-t pt-4 border-gray-500 h-auto'>
